...
with st.sidebar:
    ...
    st.markdown(f"""
        <div style = 'background-color : #B2BEB5; padding : 16px; border-radius : 10px; line-height : 1.8; color : #013220;'>
            ...
            <br>
            >>  <strong>평균 환자 수</strong> : <span style = 'color : #1E6B43'>{summary['avg_patients']}명</span>
            <br>
            >>  <strong>최다 원인 바이러스</strong> : <span style = 'color : #2C7A52'>{summary['top_virus_name']} ({summary['top_virus_count']}명)</span>
            <br>
            >>  <strong>최다 원인 시설</strong> : <span style = 'color : #337F58'>{summary['top_facility_name']} ({summary['top_facility_count']}명)</span>
        </div>
        """,
